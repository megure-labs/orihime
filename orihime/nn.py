...
"""Module foundation for learnable orihime operator parameters."""
...
class SaigoVertLinear(_OperatorModule):
    """Canonical linear-gap Saigo–Vert layer."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            map_function=sv_linear,
            value_function=sv_linear_value,
            entropy_function=sv_linear_entropy,
            learnable=learnable,
            device=device,
            dtype=dtype,
        )
...
class SaigoVertAffine(_OperatorModule):
    """Canonical affine-gap Saigo–Vert layer."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            map_function=sv_affine,
            value_function=sv_affine_value,
            entropy_function=sv_affine_entropy,
            learnable=learnable,
            device=device,
            dtype=dtype,
        )
...
SVLinear = SaigoVertLinear
SVAffine = SaigoVertAffine
NW = NeedlemanWunsch

...
The 0.1 API consists of plain map, value, and entropy functions for all
fourteen algorithms, stateful ``nn`` modules, and finite named operations
under ``ops``.
...
# Public module and named-operation tiers. Import the legacy low-level module
# before replacing the kernel-package attributes so it remains available to
# Orihime's own regression tests, but do not include it in the public export
# surface.
from . import nn as nn
from . import ops as ops
from . import raw as raw
from ._public_ops import install_public_operations as _install_public_operations

_install_public_operations(ops)

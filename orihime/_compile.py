...
for _name in (
    "sv_linear_marginals_grad_gap",
    "sv_linear_marginals_grad_temp",
    "sv_affine_marginals_grad_gap_open",
    "sv_affine_marginals_grad_gap_ext",
    "sv_affine_marginals_grad_temp",
...
_SHIPPED_OPS = (
    ...
    "sv_linear_forward",
    "sv_linear_forward_t",
    "sv_linear_value_grad_params",
    "sv_linear_marginals_backward",
    "sv_linear_marginals_hvp",
    "sv_linear_marginals_grad_gap",
    "sv_linear_marginals_grad_temp",
    # Saigo–Vert affine
    "sv_affine_forward",
    "sv_affine_forward_t",
    "sv_affine_value_grad_params",
    "sv_affine_marginals_backward",
    "sv_affine_marginals_hvp",
    "sv_affine_marginals_grad_gap_open",
    "sv_affine_marginals_grad_gap_ext",
    "sv_affine_marginals_grad_temp",
    # Needleman-Wunsch

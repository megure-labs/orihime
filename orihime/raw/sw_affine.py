...
"""Raw vector-Jacobian products for affine Smith-Waterman."""

from __future__ import annotations

from torch import Tensor

from ..sw import _sw_affine_operator
from ._base import VJPFields, _RawVJP
from ..ops import sw_affine as _kernel_bindings  # noqa: F401
from ..ops.sw_affine import *  # noqa: F401,F403
...
def _vjp_one_impl(
    ...
    *,
    ...
    result = _sw_affine_operator._vjp_one(
        pair_scores,
        gap_open_score,
        gap_extend_score,
        temperature,
...
def vjp_one(
    ...
    *,
    ...
    """Return one selected affine-gap parameter VJP.
...
def vjp(
    ...
    *,
    ...
    """Return selected affine-gap parameter VJPs in a dictionary.

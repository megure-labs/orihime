...
alignment = ori.mas(scores, temperature=0.9)
value = ori.mas_value(scores, temperature=0.9)
entropy = ori.mas_entropy(scores, temperature=0.9)
...
available under `ori.raw.mas`; the stateful layer is
`ori.nn.MonotonicAlignmentSearch`.

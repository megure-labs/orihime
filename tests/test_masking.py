...
# times temperature (in-domain, <= 80), NOT d2p's internal sentinel, so the test cannot
...
def _masked_and_reference(
    ...
    # Independent, temperature-scaled exclusion the test constructs itself (not d2p's sentinel).
    excluded = (

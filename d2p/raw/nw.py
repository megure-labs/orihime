...
"""No-graph vector-Jacobian products for Needleman-Wunsch."""

from __future__ import annotations

from torch import Tensor

from ..nw import _nw_operator
from ._base import VJPFields, _RawVJP
from ..ops import nw as _kernel_bindings  # noqa: F401
from ..ops.nw import *  # noqa: F401,F403
...
def _vjp_one_impl(
    ...
    *,
    ...
    internal = {"gap_score": "gap", "temperature": "temp"}[wrt]
    result = _nw_operator._vjp_one(
        pair_scores,
        gap_score,
        temperature,
        grad_map=cotangent,
...
def vjp_one(
    ...
    *,
    ...
    """Return one selected parameter VJP as a tensor.
...
def vjp(
    ...
    *,
    ...
    """Return selected parameter VJPs in a dictionary.

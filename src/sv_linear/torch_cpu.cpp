...
std::vector<torch::Tensor> d2p_sv_linear_forward_cpu(
    torch::Tensor scores,
    double gap,
    double temp,
...
std::vector<torch::Tensor> d2p_sv_linear_forward_t_cpu(
    torch::Tensor scores,
    torch::Tensor gap,
    torch::Tensor temp,
    torch::Tensor lengths
...
std::tuple<torch::Tensor, torch::Tensor> d2p_sv_linear_value_grad_params_cpu(
    torch::Tensor scores,
    double gap,
    double temp,
    c10::optional<torch::Tensor> lengths
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> d2p_sv_linear_marginals_backward_cpu(
    torch::Tensor scores,
...
torch::Tensor d2p_sv_linear_marginals_hvp_cpu(
    torch::Tensor scores,
    torch::Tensor v,
    double gap,
    double temp,
...
torch::Tensor d2p_sv_linear_marginals_grad_gap_cpu(
    torch::Tensor scores,
    double gap,
    double temp,
    c10::optional<torch::Tensor> lengths
...
torch::Tensor d2p_sv_linear_marginals_grad_temp_cpu(
    torch::Tensor scores,
    double gap,
    double temp,
    c10::optional<torch::Tensor> lengths
...
TORCH_LIBRARY_IMPL(d2p, CPU, m) {
    ...
    // Namespaced API
    m.impl("sv_linear_forward", d2p_sv_linear_forward_cpu);
    m.impl("sv_linear_forward_t", d2p_sv_linear_forward_t_cpu);
    m.impl("sv_linear_value_grad_params", d2p_sv_linear_value_grad_params_cpu);
    m.impl("sv_linear_marginals_backward", d2p_sv_linear_marginals_backward_cpu);
    m.impl("sv_linear_marginals_hvp", d2p_sv_linear_marginals_hvp_cpu);
    m.impl("sv_linear_marginals_grad_gap", d2p_sv_linear_marginals_grad_gap_cpu);
    m.impl("sv_linear_marginals_grad_temp", d2p_sv_linear_marginals_grad_temp_cpu);
}

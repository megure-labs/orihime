...
std::vector<torch::Tensor> orihime_sv_linear_forward_cuda(
    torch::Tensor scores,
    double gap,
    double temp,
...
std::vector<torch::Tensor> orihime_sv_linear_forward_t_cuda(
    torch::Tensor scores,
    torch::Tensor gap,
    torch::Tensor temp,
    torch::Tensor lengths
...
std::tuple<torch::Tensor, torch::Tensor> orihime_sv_linear_value_grad_params_cuda(
    torch::Tensor scores,
    double gap,
    double temp,
    c10::optional<torch::Tensor> lengths
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> orihime_sv_linear_marginals_backward_cuda(
    torch::Tensor scores,
...
torch::Tensor orihime_sv_linear_marginals_hvp_cuda(
    torch::Tensor scores,
    torch::Tensor v,
    double gap,
    double temp,
...
torch::Tensor orihime_sv_linear_marginals_grad_gap_cuda(
    torch::Tensor scores,
    double gap,
    double temp,
    c10::optional<torch::Tensor> lengths
...
torch::Tensor orihime_sv_linear_marginals_grad_temp_cuda(
    torch::Tensor scores,
    double gap,
    double temp,
    c10::optional<torch::Tensor> lengths
...
TORCH_LIBRARY_IMPL(orihime, CUDA, m) {
    ...
    // Namespaced API
    m.impl("sv_linear_forward", orihime_sv_linear_forward_cuda);
    m.impl("sv_linear_forward_t", orihime_sv_linear_forward_t_cuda);
    m.impl("sv_linear_value_grad_params", orihime_sv_linear_value_grad_params_cuda);
    m.impl("sv_linear_marginals_backward", orihime_sv_linear_marginals_backward_cuda);
    m.impl("sv_linear_marginals_hvp", orihime_sv_linear_marginals_hvp_cuda);
    m.impl("sv_linear_marginals_grad_gap", orihime_sv_linear_marginals_grad_gap_cuda);
    m.impl("sv_linear_marginals_grad_temp", orihime_sv_linear_marginals_grad_temp_cuda);
}

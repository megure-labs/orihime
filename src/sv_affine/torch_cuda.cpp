...
std::vector<torch::Tensor> orihime_sv_affine_forward_cuda(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
std::vector<torch::Tensor> orihime_sv_affine_forward_t_cuda(
    torch::Tensor scores,
    torch::Tensor gap_open,
    torch::Tensor gap_ext,
    torch::Tensor temp,
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> orihime_sv_affine_value_grad_params_cuda(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> orihime_sv_affine_marginals_backward_cuda(
    torch::Tensor scores,
...
torch::Tensor orihime_sv_affine_marginals_hvp_cuda(
    torch::Tensor scores,
    torch::Tensor v,
    double gap_open,
    double gap_ext,
...
torch::Tensor orihime_sv_affine_marginals_grad_gap_open_cuda(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
torch::Tensor orihime_sv_affine_marginals_grad_gap_ext_cuda(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
torch::Tensor orihime_sv_affine_marginals_grad_temp_cuda(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
TORCH_LIBRARY_IMPL(orihime, CUDA, m) {
    ...
    // sv_affine namespace
    m.impl("sv_affine_forward", orihime_sv_affine_forward_cuda);
    m.impl("sv_affine_forward_t", orihime_sv_affine_forward_t_cuda);
    m.impl("sv_affine_value_grad_params", orihime_sv_affine_value_grad_params_cuda);
    m.impl("sv_affine_marginals_backward", orihime_sv_affine_marginals_backward_cuda);
    m.impl("sv_affine_marginals_hvp", orihime_sv_affine_marginals_hvp_cuda);
    m.impl("sv_affine_marginals_grad_gap_open", orihime_sv_affine_marginals_grad_gap_open_cuda);
    m.impl("sv_affine_marginals_grad_gap_ext", orihime_sv_affine_marginals_grad_gap_ext_cuda);
    m.impl("sv_affine_marginals_grad_temp", orihime_sv_affine_marginals_grad_temp_cuda);
}

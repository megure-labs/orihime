...
std::vector<torch::Tensor> d2p_sv_affine_forward_cpu(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
std::vector<torch::Tensor> d2p_sv_affine_forward_t_cpu(
    torch::Tensor scores,
    torch::Tensor gap_open,
    torch::Tensor gap_ext,
    torch::Tensor temp,
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> d2p_sv_affine_value_grad_params_cpu(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> d2p_sv_affine_marginals_backward_cpu(
    torch::Tensor scores,
...
torch::Tensor d2p_sv_affine_marginals_hvp_cpu(
    torch::Tensor scores,
    torch::Tensor v,
    double gap_open,
    double gap_ext,
...
torch::Tensor d2p_sv_affine_marginals_grad_gap_open_cpu(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
torch::Tensor d2p_sv_affine_marginals_grad_gap_ext_cpu(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
torch::Tensor d2p_sv_affine_marginals_grad_temp_cpu(
    torch::Tensor scores,
    double gap_open,
    double gap_ext,
    double temp,
...
TORCH_LIBRARY_IMPL(d2p, CPU, m) {
    ...
    // sv_affine namespace
    m.impl("sv_affine_forward", d2p_sv_affine_forward_cpu);
    m.impl("sv_affine_forward_t", d2p_sv_affine_forward_t_cpu);
    m.impl("sv_affine_value_grad_params", d2p_sv_affine_value_grad_params_cpu);
    m.impl("sv_affine_marginals_backward", d2p_sv_affine_marginals_backward_cpu);
    m.impl("sv_affine_marginals_hvp", d2p_sv_affine_marginals_hvp_cpu);
    m.impl("sv_affine_marginals_grad_gap_open", d2p_sv_affine_marginals_grad_gap_open_cpu);
    m.impl("sv_affine_marginals_grad_gap_ext", d2p_sv_affine_marginals_grad_gap_ext_cpu);
    m.impl("sv_affine_marginals_grad_temp", d2p_sv_affine_marginals_grad_temp_cpu);
}

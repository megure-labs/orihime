...
TORCH_LIBRARY_IMPL(orihime, CPU, m) {
    m.impl("soft_damerau", orihime::damerau::soft_damerau_cpu);
    m.impl("soft_damerau_float", orihime::damerau::soft_damerau_cpu_float);
    m.impl("soft_damerau_with_grads", orihime::damerau::soft_damerau_cpu_with_grads);
    m.impl("soft_damerau_hvp", orihime::damerau::soft_damerau_hvp_cpu_impl);
    m.impl("soft_damerau_param_jacobian", orihime::damerau::soft_damerau_param_jacobian_cpu);
    m.impl("soft_damerau_backward_full", orihime::damerau::soft_damerau_backward_full_cpu_impl);

    m.impl("damerau_forward", orihime::damerau::damerau_forward_cpu);
    m.impl("damerau_forward_t", orihime::damerau::damerau_forward_t_cpu);
    m.impl("damerau_value_grad_params", orihime::damerau::damerau_value_grad_params_cpu);
    m.impl("damerau_marginals_backward", orihime::damerau::damerau_marginals_backward_cpu);
    m.impl("damerau_marginals_hvp", orihime::damerau::damerau_marginals_hvp_cpu);
    m.impl("damerau_marginals_grad_ins_cost", orihime::damerau::damerau_marginals_grad_ins_cost_cpu);
    m.impl("damerau_marginals_grad_del_cost", orihime::damerau::damerau_marginals_grad_del_cost_cpu);
    m.impl("damerau_marginals_grad_trans_cost", orihime::damerau::damerau_marginals_grad_trans_cost_cpu);
    m.impl("damerau_marginals_grad_temp", orihime::damerau::damerau_marginals_grad_temp_cpu);
}

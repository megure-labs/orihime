...
/**
 * @file torch_hip.cpp
 * @brief Soft True Damerau-Levenshtein HIP PyTorch Bindings
 *
 * Provides torch.ops.orihime.soft_damerau* operators with HIP implementations
 * through PyTorch's CUDA dispatch key.
 *
...
int64_t checked_damerau_alpha_size_hip(int64_t B, int64_t L1, int64_t L2) {
    TORCH_CHECK(
...
void validate_damerau_inputs_hip(const torch::Tensor& sub_costs, const torch::Tensor& trans_src) {
    ...
    checked_damerau_alpha_size_hip(sub_costs.size(0), sub_costs.size(1), sub_costs.size(2));
    TORCH_CHECK(
...
void validate_damerau_lengths_hip(
...
torch::Tensor resolve_damerau_lengths_hip(
    ...
    validate_damerau_lengths_hip(lengths, B, L1, L2, device);
    return lengths;
}

void validate_damerau_backward_input_hip(
...
public:
    static torch::autograd::variable_list forward(
        ...
        validate_damerau_inputs_hip(sub_costs, trans_src);
        ...
        const int64_t alpha_size = checked_damerau_alpha_size_hip(B, L1, L2);
        ...
        auto lengths_t = resolve_damerau_lengths_hip(lengths, B, L1, L2, sub_costs.device());
    ...
    static torch::autograd::variable_list backward(
        ...
        if (grad_posteriors.defined() && grad_posteriors.numel() > 0) {
            validate_damerau_backward_input_hip(sub_costs, grad_posteriors);
...
std::vector<torch::Tensor> soft_damerau_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    torch::Tensor ins_cost_t,
    torch::Tensor del_cost_t,
...
std::vector<torch::Tensor> soft_damerau_float_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
...
torch::Tensor soft_damerau_hvp_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    torch::Tensor V,
    double ins_cost,
...
torch::Tensor soft_damerau_param_jacobian_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    int64_t param_type,
    double ins_cost,
...
soft_damerau_backward_full_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    ...
    validate_damerau_backward_input_hip(sub_costs, grad_output);
...
std::vector<torch::Tensor> damerau_forward_hip_wrapper(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
    ...
    return soft_damerau_float_hip(
        sub_costs, trans_src, ins_cost, del_cost, trans_cost, temp, lengths
    );
}

std::vector<torch::Tensor> damerau_forward_t_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    ...
    return soft_damerau_hip(
        sub_costs, trans_src, ins_cost, del_cost, trans_cost, temp, lengths
    );
}

std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
damerau_value_grad_params_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
    ...
    auto result = soft_damerau_with_grads_hip(
        sub_costs, trans_src, ins_cost, del_cost, trans_cost, temp, lengths
    );
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
damerau_marginals_backward_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    ...
    auto grad_sub_costs = soft_damerau_hvp_hip(
        sub_costs,
        trans_src,
        grad_marginals_c,
        ins_cost,
    ...
    auto grad_ins_jacobian = soft_damerau_param_jacobian_hip(
        sub_costs, trans_src, 0, ins_cost, del_cost, trans_cost, temp, lengths
    );
    auto grad_del_jacobian = soft_damerau_param_jacobian_hip(
        sub_costs, trans_src, 1, ins_cost, del_cost, trans_cost, temp, lengths
    );
    auto grad_trans_jacobian = soft_damerau_param_jacobian_hip(
        sub_costs, trans_src, 2, ins_cost, del_cost, trans_cost, temp, lengths
    );
    auto grad_temp_jacobian = soft_damerau_param_jacobian_hip(
...
torch::Tensor damerau_marginals_hvp_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    torch::Tensor v,
    double ins_cost,
    ...
    return soft_damerau_hvp_hip(
        sub_costs, trans_src, v, ins_cost, del_cost, trans_cost, temp, lengths
    );
}

torch::Tensor damerau_marginals_grad_ins_cost_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
    ...
    return soft_damerau_param_jacobian_hip(
        sub_costs, trans_src, 0, ins_cost, del_cost, trans_cost, temp, lengths
    );
}

torch::Tensor damerau_marginals_grad_del_cost_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
...
torch::Tensor damerau_marginals_grad_trans_cost_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
...
torch::Tensor damerau_marginals_grad_temp_hip(
    torch::Tensor sub_costs,
    torch::Tensor trans_src,
    double ins_cost,
    double del_cost,
...
TORCH_LIBRARY_IMPL(orihime, CUDA, m) {
    m.impl("soft_damerau", orihime::damerau::soft_damerau_hip);
    m.impl("soft_damerau_float", orihime::damerau::soft_damerau_float_hip);
    m.impl("soft_damerau_with_grads", orihime::damerau::soft_damerau_with_grads_hip);
    m.impl("soft_damerau_hvp", orihime::damerau::soft_damerau_hvp_hip);
    m.impl("soft_damerau_param_jacobian", orihime::damerau::soft_damerau_param_jacobian_hip);
    m.impl("soft_damerau_backward_full", orihime::damerau::soft_damerau_backward_full_hip);

    m.impl("damerau_forward", orihime::damerau::damerau_forward_hip_wrapper);
    m.impl("damerau_forward_t", orihime::damerau::damerau_forward_t_hip);
    m.impl("damerau_value_grad_params", orihime::damerau::damerau_value_grad_params_hip);
    m.impl("damerau_marginals_backward", orihime::damerau::damerau_marginals_backward_hip);
    m.impl("damerau_marginals_hvp", orihime::damerau::damerau_marginals_hvp_hip);
    m.impl("damerau_marginals_grad_ins_cost", orihime::damerau::damerau_marginals_grad_ins_cost_hip);
    m.impl("damerau_marginals_grad_del_cost", orihime::damerau::damerau_marginals_grad_del_cost_hip);
    m.impl("damerau_marginals_grad_trans_cost", orihime::damerau::damerau_marginals_grad_trans_cost_hip);
    m.impl("damerau_marginals_grad_temp", orihime::damerau::damerau_marginals_grad_temp_hip);
}

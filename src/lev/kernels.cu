...
__global__ void lev_backward_diag_kernel(
    ...
    d2p::common::KahanSum local_ins_grad;
    d2p::common::KahanSum local_del_grad;
    d2p::common::KahanSum local_T_grad;
...
__global__ void lev_boundary_grad_kernel(
    ...
    d2p::common::KahanSum del_acc;
    d2p::common::KahanSum ins_acc;

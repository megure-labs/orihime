...
TORCH_LIBRARY_IMPL(d2p, CPU, m) {
    m.impl("soft_levenshtein", d2p::lev::soft_levenshtein_cpu);
    m.impl("soft_levenshtein_float", d2p::lev::soft_levenshtein_cpu_float);
    m.impl("soft_levenshtein_with_grads", d2p::lev::soft_levenshtein_cpu_with_grads);
    m.impl("soft_levenshtein_hvp", d2p::lev::soft_levenshtein_hvp_cpu);
    m.impl("soft_levenshtein_param_jacobian", d2p::lev::soft_levenshtein_param_jacobian_cpu);
    m.impl("soft_levenshtein_backward_full", d2p::lev::soft_levenshtein_backward_full_cpu);

    m.impl("lev_forward", d2p::lev::lev_forward_cpu_wrapper);
    m.impl("lev_forward_t", d2p::lev::lev_forward_t_cpu);
    m.impl("lev_value_grad_params", d2p::lev::lev_value_grad_params_cpu);
    m.impl("lev_marginals_backward", d2p::lev::lev_marginals_backward_cpu);
    m.impl("lev_marginals_hvp", d2p::lev::lev_marginals_hvp_cpu);
    m.impl("lev_marginals_grad_ins_cost", d2p::lev::lev_marginals_grad_ins_cost_cpu);
    m.impl("lev_marginals_grad_del_cost", d2p::lev::lev_marginals_grad_del_cost_cpu);
    m.impl("lev_marginals_grad_temp", d2p::lev::lev_marginals_grad_temp_cpu);
}
